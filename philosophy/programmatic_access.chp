...
There is a term *programmatic access*

- explain shell scripts and windows one click
  this is the major reason for the anti-windows schtick (comment on evil empire etc)
